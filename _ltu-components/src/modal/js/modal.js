...
window.openModal = function openModal(target, content, maxWidth='1280px'){
     ...
     // create overlay
     var dialog = '<div role="dialog" aria-modal="true" class="overlay"><div class="ds-modal">'+content+'</div><button id="overlay-close" class="ds-btn-round ds-btn-round--light ds-icon-x">Close</button></div>';
