...
function makeNativeSVGLayer(layer) {
  ...
  try {
    ...
    console.log('SVG import failed: ' + String(e));
  }
...
function getNativeLayer(failingLayers, layer) {
  ...
  try {
    ...
    console.log('Layer failed to import: ' + String(layer.name));
    return null;
  }
...
function asketch2sketch(context, asketchFiles) {
  ...
  if (asketchDocument) {
    ...
    if (asketchDocument.assets.colors) {
      ...
      console.log('Shared colors added: ' + String(asketchDocument.assets.colors.length));
    }
    ...
    if (asketchDocument.layerTextStyles && asketchDocument.layerTextStyles.objects) {
      ...
      console.log('Shared text styles added: ' + String(asketchDocument.layerTextStyles.objects.length));
    }
  }
...
function createAttributedString(textNode) {
  ...
  try {
    ...
    console.log('Failed to create attributed string: ' + String(e));
  }
