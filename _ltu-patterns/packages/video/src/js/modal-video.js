...
$('body').on('click', 'a[data-youtube]', function(e) {
    ...
    // create overlay
    var dialog = '<div role="dialog" aria-modal="true" class="overlay"><button id="overlay-close" class="ds-btn--round-light icon-x">Close</button><div class="ds-modal"><div class="ds-video"><iframe id="vid-'+videoId+'" width="560" height="315" type="text/html" src="https://www.youtube.com/embed/'+videoId+'?rel=0&amp;autoplay=1" frameborder="0" allowfullscreen></iframe></div></div></div>';
